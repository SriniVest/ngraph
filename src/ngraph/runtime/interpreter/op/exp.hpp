...
template <typename T>
class ngraph::runtime::interpreter::ExpExec : public ExecNode<T>
{
public:
    ...
    ExpExec(const ngraph::Node* node)
        : m_node{dynamic_cast<const ngraph::op::Exp*>(node)}
    {
