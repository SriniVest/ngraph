...
#include "ngraph/runtime/reference/get_output_element.hpp"
...
template <typename T>
class ngraph::runtime::interpreter::GetOutputElementExec : public ExecNode<T>
{
public:
...
private:
    const ngraph::op::GetOutputElement* m_node;
};
