...
#include "ngraph/runtime/reference/stop_gradient.hpp"
...
template <typename T>
class ngraph::runtime::interpreter::StopGradientExec : public ExecNode<T>
{
public:
...
private:
    const ngraph::op::StopGradient* m_node;
};
