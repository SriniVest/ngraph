...
template <typename T>
class ngraph::runtime::interpreter::NotExec : public ExecNode<T>
{
public:
    ...
    NotExec(const ngraph::Node* node)
        : m_node{dynamic_cast<const ngraph::op::Not*>(node)}
    {
