...
template <typename T>
class ngraph::runtime::interpreter::AbsExec : public ExecNode<T>
{
public:
    ...
    AbsExec(const ngraph::Node* node)
        : m_node{dynamic_cast<const ngraph::op::Abs*>(node)}
    {
