...
template <typename T>
class ngraph::runtime::interpreter::LogExec : public ExecNode<T>
{
public:
    ...
    LogExec(const ngraph::Node* node)
        : m_node{dynamic_cast<const ngraph::op::Log*>(node)}
    {
